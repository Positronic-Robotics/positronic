...
`make build-groot` uses `GROOT_BASE_IMAGE` from the GR00T fork. The fork image contains
...
Build the base in the [fork](https://github.com/Positronic-Robotics/gr00t), then build the adapter:
