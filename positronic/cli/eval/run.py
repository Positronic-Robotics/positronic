...
def run(
    eval: Eval, policy, output_dir=None, inference_latency=False, timing=False, ready_timeout=DEFAULT_READY_TIMEOUT
):
    ...
    main(policy=policy, evals=[eval], output_dir=output_dir, timing=timing, ready_timeout=ready_timeout)
