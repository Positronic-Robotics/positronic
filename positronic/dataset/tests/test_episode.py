...
def test_discarding_moves_the_recording_out_and_blocks_further_use(tmp_path):
...
def test_a_discarded_episode_keeps_its_static_data_and_identity(tmp_path):
