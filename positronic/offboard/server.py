...
class PolicyServer:
    ...
    async def _answer_observations(self, conn: wire.ServerConnection, session: Session, session_id: str) -> None:
    ...
    def _open_frame_channel(self, started: Sequence[wire.Wire]) -> None:
...
@cfn.config(
    host='0.0.0.0', port=8000, recording_dir=None, idle_timeout_min=None, grpc_port=None, uds=None, frame_ring=True
)
def serve(
    pipeline: cfn.Config,
    host: str,
