...
# desync until then.
# rules-allow: hardcoded-keys — fixing one entry leaves the rest on the old pattern; the TODO above names the
# whole-table fix, and the test above catches a desync meanwhile
