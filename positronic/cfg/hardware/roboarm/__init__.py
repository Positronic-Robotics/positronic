...
@cfn.config(channel='can0', sim=False, base_pose=None, gravity_comp_factor=None, park_after_idle_s=60.0)
def yam(channel: str, sim: bool, base_pose, gravity_comp_factor, park_after_idle_s: float | None):
