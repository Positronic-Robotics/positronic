...
STACK_RED_CUBE = AddBox(name='box_0', size=(0.02, 0.02, 0.01), pos=(0.0, 0.0, 0.01), rgba=(1, 0, 0, 1), freejoint=True)
STACK_GREEN_CUBE = AddBox(
    name='box_1', size=(0.02, 0.02, 0.01), pos=(0.0, 0.0, 0.01), rgba=(0, 1, 0, 1), freejoint=True
)
...
def stack_cubes_loaders():
    return [
        ...
        STACK_RED_CUBE,
        SetBodyPosition(body_name=STACK_RED_CUBE.body_name, random_position=((0.31, -0.28, 0.31), (0.69, 0.28, 0.31))),
        STACK_GREEN_CUBE,
        SetBodyPosition(
            body_name=STACK_GREEN_CUBE.body_name, random_position=((0.31, -0.28, 0.31), (0.69, 0.28, 0.31))
        ),
    ]
