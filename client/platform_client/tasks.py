...
The platform owns the catalogue, so an id unknown to this client still reaches the server. This
module refuses only a value that cannot be a catalogue key.
"""
