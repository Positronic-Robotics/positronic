...
An observation codec also overrides `warm_inputs(task)`, the observation that a warm runs on the inference server ([`POST /api/v1/warm`](../positronic/offboard/README.md)).
